...
const variantStyles = {
  solid: {
    ...
    gray: "bg-blue-600 text-white hover:white/99 active:bg-blue-500 active:text-white/80",
  },
  outline: {
    gray: "border-blue-600 text-blue-600 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80",
  },
};
